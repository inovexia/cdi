...
/*
//add_action ('invwp_woocommerce_show_product_review', 'invwp_woocommerce_show_product_review', 5);
function invwp_woocommerce_show_product_review () {
  woocommerce_get_template( 'single-product-reviews.php' );
}
*/

/* Functions to unset/remove single product tabs */
add_filter( 'woocommerce_product_tabs', 'invwp_custom_product_tabs' );
function invwp_custom_product_tabs( $tabs ) {
  // 1) Removing tabs
