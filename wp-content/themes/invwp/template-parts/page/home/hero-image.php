      ...
      <div class="row ">
          <div class="col-6 d-flex">
              <div class="">
                ...
                <p class="hero-buttons mt-30">
                  <a class="button button-primary text-uppercase" href="<?php echo get_permalink( wc_get_page_id( 'shop' ) );?>"><?php echo the_field('banner_button1'); ?></a>
                  <a class="button button-secondary text-uppercase" href="<?php echo site_url('about');?>"><?php echo the_field('banner_button2'); ?></a>
                </p>
          ...
          <div class="col-6 mt-5 text-right">
            <div class="banner-image-wrap">
              ...
              <img class="banner-image-front" width="<?php echo $image_front['width']; ?>" height="auto" src="<?php echo $image_front['url']; ?>" alt="<?php echo $image_front['alt']; ?>" loading="lazy" />
          </div>
        </div>
      </div>
