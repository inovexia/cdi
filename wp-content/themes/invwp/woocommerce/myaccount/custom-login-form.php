...
<div class="text-center" id="customer_login">
  ...
  <form class="woocommerce-form woocommerce-form-login login" method="post" id="checkout-custom-login-form">
    ...
    <div class="woocommerce-form-row form-row text-center forget-password d-flex">	
    ...
    <div class="woocommerce-form-row form-row ">
      ...
      <div class="d-grid gap-2">
        <button type="submit" class="woocommerce-button button woocommerce-form-login__submit button-primary text-uppercase" name="login"
