...
$(function() {
	var Accordion = function(el, multiple) {
		...
		// Variables privadas
		var links = this.el.find('.filter-link');
		// Evento
	...
	Accordion.prototype.dropdown = function(e) {
		...
		if (!e.data.multiple) {
			$el.find('.filter-submenu').not($next).slideUp().parent().removeClass('filter-open');
		};
	}	

	var accordion = new Accordion($('#filter-accordion, #mfilter-accordion'), false);
});
/* commented 26-4-22
	$(function() {
		var Accordion = function(el, multiple) {
