...
<div class="cart-page-bottom-section">
  ...
  <div class="cart-footer-right">
      <div class="cart-page-buttons">
          <a class="button button-primary text-uppercase" href="<?php echo get_permalink( wc_get_page_id( 'shop' ) ); ?>">Continue Shopping</a>
          <?php
    				/**
    				 * Cart collaterals hook.
    				 *
    				 ...
    				 */
    				do_action( 'invwp_proceed_to_checkout');
    			?>
      </div>
      <div class="shipping-info-text">
          <p>Shipping cost will be calculated based on your shipping address.</p>
      </div>
  </div>
</div>
