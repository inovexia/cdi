                  ...
                  <form id="registration-form-wrp" class=" my-0 form-horizontal" <?php do_action( 'woocommerce_register_form_tag' ); ?>>
                     ...
                     <fieldset id="cur-step2" class="registtration-tab">
                        ...
                        <div class="form-group row">
                            ...
                            <input type="radio" id="patient_male" name="patient_male" value="HTML">
                            <label for="patient_female">Female</label>
<input type="radio" id="css" name="patient_female" value="CSS">
<label for="patient_other">Other</label>
<input type="radio" id="javascript" name="patient_other" value="JavaScript">
